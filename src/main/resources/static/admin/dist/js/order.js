$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '收件人', name: 'userName', index: 'userName', width: 10, hidden: true},
...
function openExpressInfo(orderId) {
    ...
    $('#expressInfoModalLabel').html('');
    $('#expressInfoModal').modal('show');
    var userInfo = "收货人：" + rowData.userName + '<br>' + "电话：" + rowData.userPhone + '<br>' + "收货地址：" + rowData.userAddress;
    $("#userAddressInfo").html(userInfo);
}
